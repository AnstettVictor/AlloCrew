...
const Information = (state) => {
  console.log("STAAAAAAAAAAAAAAAATE", state)
  return (
    <div>
      <div className="information">
        ...
        <section class="cards">
          ...
          <article class="card card--3">
            ...
            <div class="card__img"></div>
            <a href="https://www.linkedin.com/in/charlie-boyer-871189129/" class="card_link">
              <div class="card__img--hover"></div>
            </a>
            <div class="card__info">
          ...
          <article class="card card--4">
            ...
            <div class="card__img"></div>
            <a href="https://www.linkedin.com/in/alexis-carrere" class="card_link">
              <div class="card__img--hover"></div>
            </a>
            <div class="card__info">
              <span class="card__category"> Alexis Carrere</span>
